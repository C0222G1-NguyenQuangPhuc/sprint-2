...
public interface IProductRepository extends JpaRepository<Product, Integer> {
    ...
    @Query(value = "SELECT * FROM product where delete_status = 0 ORDER BY release_time DESC ", nativeQuery = true)
    ...
    @Query(value = "SELECT * FROM product where delete_status = 0 ORDER BY release_time ", nativeQuery = true)
